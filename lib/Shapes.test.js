...
describe('Shape', () => {
    ...
    describe('Render Circle',() => {
        it('Should Render a Circle', () => {
            //arange
            const circle = `<svg version="1.1" width="300" height="300" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="#000" /><text x="150" y="150" font-size="60" text-anchor="middle" fill="#FFF">ABC</text></svg>`
    ...
    describe('Render Triangle',() => {
        it('Should Render a Triangle', () => {
            //arange
            const triange = `<svg version="1.1" width="300" height="300" xmlns="http://www.w3.org/2000/svg"><polygon points="150,100 50,275 250,275" fill="#000" /><text x="150" y="240" font-size="60" text-anchor="middle" fill="#FFF">ABC</text></svg>`
